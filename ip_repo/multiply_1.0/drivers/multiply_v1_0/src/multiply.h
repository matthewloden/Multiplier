...
#define MULTIPLY_S00_AXI_SLV_REG3_OFFSET 12
 ...
 *
 * @param   BaseAddress is the base address of the MULTIPLYdevice.
 ...
 * @note
 * C-style signature:
 * 	void MULTIPLY_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	u32 MULTIPLY_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
